...
你的任务是根据策略理解 Agent 输出的 Brief，生成横版 16:9 原生广告封面方案，并组装可用于图片生成模型的 Prompt。
...
生成一张横板 16:9 的原生广告大图。整体风格要像用户在内容流里刷到的一张高点击内容封面，而不是传统商业海报。
...
最终目标：生成一张横板 16:9 高点击原生广告素材，让用户第一眼感觉像一条自然、有场景、有结果、有轻微悬念的内容封面，而不是一张明显的广告图，从而更愿意停留并点击。
`;
